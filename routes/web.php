...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('/ajax/trademarks/client-ref', [App\Http\Controllers\TrademarksController::class, 'searchClientRef'])
    ->name('ajax.trademarks.client_ref');

    Route::get('/ajax/trademarks/name', [App\Http\Controllers\TrademarksController::class, 'searchTrademarkName'])
        ->name('ajax.trademarks.name');

    Route::get('/ajax/clients/autocomplete', [App\Http\Controllers\TrademarksController::class, 'searchClientsAutocomplete'])
        ->name('ajax.clients.autocomplete');

    Route::get('/ajax/holders/autocomplete', [App\Http\Controllers\TrademarksController::class, 'searchHoldersAutocomplete'])
        ->name('ajax.holders.autocomplete');
});
