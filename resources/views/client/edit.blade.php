          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-3">Editar Cliente</h3>
               <a class="btn" href="{{ route('index.clients') }}" style="background: {{$configuracion->color_boton_close}}; color: #ffff"> Atrás</a>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-lg-9 mt-lg-0 mt-4">
                                ...
                                <div class="card mt-4">
                                    ...
                                    <a href="javascript:;" id="agregar_address" class="btn" style="background-color:#001d3d;color:  #41CC2E!important; border: 2px solid #41CC2E!important;">Agregar
                                        address client</a>
                                </div>
                                ...
                                <div class="card mt-4">
                                    ...
                                    <a href="javascript:;" id="agregar_phone" class="btn" style="background-color:#001d3d;color:  #41CC2E!important; border: 2px solid #41CC2E!important;">Agregar
                                        phone client</a>
                                </div>
