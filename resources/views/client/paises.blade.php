        ...
        <option value="">Eurasian Patent Organization</option>
        <option value="">European Patent Office (EPO)</option>
        <option value="">European Union Intellectual Property Office</option>
        ...
        <option value="">World Intellectual Property Organization</option>
